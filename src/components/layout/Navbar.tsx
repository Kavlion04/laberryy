...
const Navbar = () => {
  ...
  const handleMapLocationSelect = (lat: number, lng: number) => {
    ...
    // This is just logging the coordinates, you'd typically use these values
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <Link to="/" className="flex items-center gap-2 text-primary">
              ...
              <span className="text-xl font-semibold hidden sm:inline-block">BookMaster</span>
            </Link>
          </div>

          {/* Search Bar - Hidden on Mobile until toggled */}
          <div className={`absolute left-0 top-0 w-full p-3 bg-background md:relative md:block md:w-auto md:p-0 md:mx-4 md:flex-1 ${isSearchVisible ? 'block' : 'hidden'}`}>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  <DropdownMenuItem onClick={toggleRole} className="sm:hidden">
                    Switch to {role === 'customer' ? 'Librarian' : 'Customer'} View
                  </DropdownMenuItem>
